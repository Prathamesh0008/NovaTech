...
export default function HeroSection() {
  return (
    <section className="relative w-full mb-12 min-h-screen bg-gradient-to-r from-blue-200 to-blue-400 overflow-hidden flex flex-col md:flex-row items-center justify-between p-10">
