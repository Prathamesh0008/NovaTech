  ...
  return (
    ...
    >
        ...
        <div>
          ...
          >
            <input
              ...
              className="flex-2 px-2 py-2 text-gray-700 outline-none"
              required
            />
            <button
              type="submit"
              className="bg-[#3386bc] text-white px-3 py-2 hover:bg-[#4bb2e5] transition-colors duration-300 flex items-center gap-1"
            >
      ...
      <div className="border-t border-white/20 mt-10 pt-4 text-center text-sm text-gray-300">
        <p>
          © {new Date().getFullYear()} <span className="text-[#b2e3e1] font-medium">NovaTech Sciences</span>.  
          All rights reserved.
        </p>
