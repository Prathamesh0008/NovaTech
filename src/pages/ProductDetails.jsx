    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f9fb] via-[#f3f8fa] to-[#e8f3f8]">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 space-y-12 pb-20">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            ...
            <div className="mt-6 text-gray-700 leading-relaxed min-h-[120px]">
              {activeTab === "indication" && (
                <p>{product.indication || "No indication available."}</p>
              )}
              {activeTab === "presentation" && (
                <p>{product.presentation || "No presentation info."}</p>
              )}
            </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Important Information & FAQs</h2>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:flex items-center gap-10">
          <div className="md:w-2/3 space-y-4">
            ...
            <p className="text-gray-600">
              Always consult your healthcare provider before using {product.name}. Avoid
              self-medication and follow prescribed dosages only.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Avoid alcohol or other substances that may interfere with treatment.</li>
              <li>Seek immediate medical attention if unusual symptoms appear.</li>
            </ul>
          </div>
