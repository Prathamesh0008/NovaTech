...
export default function ProductDetails() {
  ...
  // Use product.faq if present, otherwise fallback
  ...
  // Helper: convert multiline text (with blank lines) into bullets
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f5f9fb] via-[#f3f8fa] to-[#e8f3f8]">
      ...
      <Meta name="robots" content={product.seoRobots || "index, follow"} />
          ...
          <section className="mt-14 pb-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {related.map((p) => (
                <Link
                  key={p.id}
                  to={`/products/${category}/${slugify(p.name)}`}
                >
